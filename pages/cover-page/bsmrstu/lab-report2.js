...

                {
                    ...
                    <>
                        ...
                        <div className='d-flex justify-content-center align-items-center'>
                            <PDFDownloadLink style={{ color: '#fff', borderRadius: '5px', backgroundColor: '#28a745', padding: '7px 25px', textDecoration: 'none', }} document={<LabReport2 data={assignmentData} />} fileName={`lab_report_${assignmentData?.course_code}.pdf`}>
