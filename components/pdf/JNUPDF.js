  ...
  return (
    <Document>
      <Page
        ...
        hyphenationCallback={(word) => [word]} // <-- FIX APPLIED HERE
      >
        <View>
        ...
        <View>
          <Text style={[styles.text, styles.secondaryColor, styles.bold]}>
            {" "}
            Assignment On{" "}
          </Text>
          <Text style={styles.subheader}> {assignment_title} </Text>
          {assignment_no && (
            <Text style={styles.text}> {assignment_title} </Text>
          )}
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            <View style={[styles.tableCol, { width: "45%" }]}></View>
            <View
            ...
            >
              ...
              <Text style={[styles.text, styles.bold]}>{student_name}</Text>
              <Text style={styles.text}>ID: {student_id}</Text>
              <Text style={styles.text}>{student_batch} Batch</Text>
              <Text style={styles.text}>
                Department of {student_department}
              </Text>
        ...
        <Text style={[styles.text, { marginTop: 30 }, styles.bold]}>
