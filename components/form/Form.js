...
export default function Form({ title = "", fields = [], PDF }) {
  ...
  return (
    <Layout>
      <section className="container py-5">
        <h1 className="my-4 text-primary" style={{ fontSize: "2rem" }}>
          {" "}
          {title}{" "}
        </h1>
          ...
          <>
            ...
            <div className="d-flex justify-content-center align-items-center">
              <PDFDownloadLink
                ...
                document={<RUPDF data={assignmentData} />}
                fileName={`${assignmentData?.student_id || "cover"}.pdf`}
              >
